...
EVENT_HUB_NAMESPACE = "raj-eventhub.servicebus.windows.net"
...
#Fetech secret value from Key Vault
...
def fetch_weather_data():
    ...
    VAULT_URL = "https://raj-key-vault-project.vault.azure.net/"
    API_KEY_SECRET_NAME = "weather-api"
